          ...
          {props.contents.reviews &&
            props.contents.reviews.map((item, index) => (
              <ReviewSection key={index}>
                <ReviewSectionAuthor>
                  <ReviewAuthorImg src="\statics\images\logoTwo.png" />
                  {item["author_name"]}
                </ReviewSectionAuthor>
                <ReviewSectionContent>{item["text"]}</ReviewSectionContent>
              </ReviewSection>
            ))}
          <ReviewMoreBtn
            onClick={() => {
              window.location.href = props.contents.place_url;
            }}
          >
            후기 더보기 ...
          </ReviewMoreBtn>
...
const ReviewSectionAuthor = styled.span`
  font-size: 16px;
  font-weight: 900;
  display: flex;
  align-items: center;
...
const ReviewMoreBtn = styled.section`
  display: flex;
...
const ReviewSectionContent = styled.span`
  overflow: hidden;
